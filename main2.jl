...
eos = (
    Stiffened(rho0=2780, s=1.338, c0=5330, cv=9.3e2, mu=27.6e9, T0=300, G0=2.13, S0=0),
    Stiffened(rho0=2780, s=1.338, c0=5330, cv=9.3e2, mu=27.6e9, T0=300, G0=2.13, S0=0)
)
...
# NOTE: Альфы приравнять, уравнения состояние одно (один материал), скорсоти одинаковые, плотности одинаковые, давления разные
Q0 = Array{Float64}(undef, 30)
# nx = 5
# Q0 = [ 0.52, 1445.65, 2569.8, -9911.14, 0.0, 2.266e7, 1445.813, 1.0107, 0.0, 1.0338, 1445.65, 0.0, 0.0, 0.0, 1445.649,
#        0.48, 4286.24, 6504.6957, 31581.07, 0.0, 8.7, 4285.72, 3.2466, 0.0, 3.32, 4286.2417, 0.0, 0.0, 0.0, 4286.2432 ]
# nx = 1000
# Q0 = [ 0.48, 1334.35, 3778.1, -8512.54, 0.0, 2.05e7, 1334.52, 1.01059, 0.0, 1.03, 1334.35, 0.0, 0.0, 0.0, 1334.35,
       # 0.52, 4643.75, 3689.20, 36042.61, 0.0, 2.6, 4643.19, 3.24, 0.0, 3.31, 4643.75, 0.0, 0.0, 0.0, 4643.75]

Q0 = [ 0.5, 1400, 3800, -8500, 0, 2e7, 1300, 1, 0, 1, 1300, 0, 0, 0, 1300,
       0.5, 1400, 3800, -8500, 0, 2e5, 4500, 3, 0, 3, 4500, 0, 0, 0, 4500 ]
